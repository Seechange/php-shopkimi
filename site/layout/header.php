...
<html>
    <head>
        <title>Trang chủ - Thời trang Kimi</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="shortcut icon" type="image/x-icon" href="../upload/K-favicon.png" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 logo">
                        <a href="#"><img height="170px" src="../upload/logokimishop450x170.png" class="img-responsive"></a>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 hotline-search">
                        <div>
                            <p class="hotline-phone"><span><strong>Hotline: </strong><a href="tel:076.276.7356">076.276.7356</a></span></p>
                            <p class="hotline-email"><span><strong>Email: </strong><a href="mailto:danh.vo.2110@gmail.com">danh.vo.2110@gmail.com</a></span></p>
                        </div>
