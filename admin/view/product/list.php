...
<div id="content-wrapper">
    <div class="container-fluid">
       ...
       <div class="action-bar">
			 <a class="btn btn-primary btn-sm" href="index.php?c=product&a=add">Thêm</a>
                   ...
                   <tbody>
                      ...
                      <tr>
                         ...
                         <?php if($product->getInventoryQty()==0): ?>
                           <td><a href="index.php?c=product&a=edit1&id=<?=$product->getId()?>" class="btn btn-info btn-sm">Nhập hàng</a></td>
                         <?php else :?>
                           <td><a href="index.php?c=product&a=edit1&id=<?=$product->getId()?>" class="btn btn-info btn-sm dis">Nhập hàng</a></td>
                         <?php endif ?>
